  ...
  private:
    ...
    */
    ...
    const QMap<QString, CommandInfo> commands {
        ...
        {"areas",              {ACLFlags.value("NONE"),         0, &AOClient::cmdGetAreas}},
        ...
        {"coin",               {ACLFlags.value("NONE"),         0, &AOClient::cmdFlip}},
        {"diceroll",           {ACLFlags.value("NONE"),         0, &AOClient::cmdRoll}},
        ...
        {"spectate",           {ACLFlags.value("CM"),           0, &AOClient::cmdSpectatable}},
        ...
        {"wt",                 {ACLFlags.value("NONE"),         0, &AOClient::cmdTestify}},
        {"testify",            {ACLFlags.value("NONE"),         0, &AOClient::cmdTestify}},
        {"testimony",          {ACLFlags.value("NONE"),         0, &AOClient::cmdTestimony}},
        {"examine",            {ACLFlags.value("NONE"),         0, &AOClient::cmdExamine}},
        {"ce",                 {ACLFlags.value("NONE"),         0, &AOClient::cmdExamine}},
        {"pause",              {ACLFlags.value("NONE"),         0, &AOClient::cmdPauseTestimony}},
        {"delete",             {ACLFlags.value("NONE"),         0, &AOClient::cmdDeleteStatement}},
        {"update",             {ACLFlags.value("NONE"),         0, &AOClient::cmdUpdateStatement}},
        {"add",                {ACLFlags.value("NONE"),         0, &AOClient::cmdAddStatement}},
